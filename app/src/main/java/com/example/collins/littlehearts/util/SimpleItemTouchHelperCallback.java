...
public class SimpleItemTouchHelperCallback extends ItemTouchHelper.Callback {
    ...
    //  which will eventually handle deleting this item from the user's "Saved Pets" in Firebase.
    ...
    //  PetListViewHolder where we will later add animations.
    ...
    //  This triggers the callback in the ItemTouchHelperViewHolder which will be sent to our PetListViewHolder.
