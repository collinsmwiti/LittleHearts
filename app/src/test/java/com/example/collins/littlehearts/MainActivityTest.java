...
import com.example.collins.littlehearts.ui.PetsActivity;
...
public class MainActivityTest{
    ...
    public void validateTextViewContent() {
        ...
        assertTrue("Little Hearts".equals(appNameTextView.getText().toString()));
    }

    @Test
    public void secondActivityStarted() {
        activity.findViewById(R.id.adoptPetsButton).performClick();
